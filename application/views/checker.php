...
<head>
    ...
    <link href="public/css/my.css" rel="stylesheet" media="all">
...
<body class="animsition">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Checker</h2>
                                        ...
                                        <div class="login-wrap">
                                            <div class="login-content">
                                                <div class="login-logo">
                                                    <a href="#">
                                                        <img src="public/images/icon/logo-tb.png" alt="CoolAdmin">
                                                    </a>
                                                </div>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col col-md-12">
                                                            <label for="textarea-input"
                                                                class=" form-control-label">Username: User<br />
                                                                Enter product key(s) separated by line breaks(maximum 10
                                                                product keys):</label>
                                                        </div>
                                                        <div class="col-12 col-md-12">
                                                            <textarea name="textarea-input" id="textarea-key" rows="9"
                                                                placeholder="Input your keys here..."
                                                                class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                    <button class="au-btn--submit" id="submit">Submit
                                                    </button>
                                                    <div id="loading"></div>
                                                    <div class="row form-group">
                                                        <div class="col col-md-12">
                                                            <label for="textarea-input"
                                                                class=" form-control-label">Result :</label>
                                                        </div>
                                                        <div class="col-12 col-md-12">
                                                            <textarea name="textarea-input" id="textarea-result"
                                                                rows="9" placeholder="Result..."
                                                                class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        $("#submit").click(function () {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url()?>/checker/check_key',
                data: {
